...
xxd -i -n cli_priv_enc_der private.der > "$TARGET_DIR/cli_enc_keys/cli_priv_enc_key.h"
xxd -i -n cli_pub_enc_der public.der > "$TARGET_DIR/cli_enc_keys/cli_pub_enc_key.h"