...
xxd -i -n ser_priv_enc_der private.der > "$TARGET_DIR/ser_enc_keys/ser_priv_enc_key.h"
xxd -i -n ser_pub_enc_der public.der > "$TARGET_DIR/ser_enc_keys/ser_pub_enc_key.h"