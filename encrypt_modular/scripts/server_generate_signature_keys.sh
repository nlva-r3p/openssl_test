...
xxd -i -n ser_priv_sig_der private.der > "$TARGET_DIR/ser_sig_keys/ser_priv_sig_key.h"
xxd -i -n ser_pub_sig_der public.der > "$TARGET_DIR/ser_sig_keys/ser_pub_sig_key.h"